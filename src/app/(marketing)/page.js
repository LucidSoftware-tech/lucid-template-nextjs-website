...
const features = [
  {
    ...
    description: "Built on Next.js App Router with a clean, scalable project structure ready for any use case.",
  },
  {
    icon: "lock",
    title: "Secure by Default",
    description: "Authentication flows, protected routes, and security best practices baked in from day one.",
  },
  {
    icon: "settings",
    title: "Fully Configurable",
    description: "Centralized configuration for site metadata, navigation, theming, and feature toggles.",
  },
];
      ...
      <section className="relative overflow-hidden bg-background pt-24 pb-32 lg:pt-36 lg:pb-48">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <h1 className="max-w-4xl text-5xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            Build something <span className="bg-gradient-to-r from-foreground to-foreground/60 bg-clip-text text-transparent">extraordinary</span>
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
            {siteConfig.description} Ship faster with a solid foundation, beautiful defaults, and everything you need out of the box.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link href="/contact" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto rounded-full px-8 text-base h-12">
                Get Started <Icons.chevronRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          ...
          <div className="mt-16 sm:mt-24 w-full max-w-5xl rounded-xl border border-border/50 bg-card/40 p-2 shadow-2xl backdrop-blur-xl">
            <div className="rounded-lg border bg-background overflow-hidden aspect-video flex items-center justify-center relative shadow-inner">
               ...
               <div className="z-10 text-center space-y-4 p-6">
                 ...
                 <h3 className="text-2xl font-bold">Your Product Preview</h3>
                 <p className="text-muted-foreground max-w-md mx-auto">Replace this with a screenshot, video embed, or interactive demo of your application.</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              A thoughtfully designed foundation with the tools and patterns that matter most.
            </p>
          </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                <div key={feature.title} className="rounded-xl border bg-card p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="mt-4 text-lg text-primary-foreground/80 max-w-xl mx-auto mb-8">
            Join thousands of teams already building with a faster, more reliable foundation.
          </p>
          <Link href="/contact">
            <Button size="lg" variant="secondary" className="rounded-full px-8 font-semibold h-12">
